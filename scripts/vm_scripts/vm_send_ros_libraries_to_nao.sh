...
rsync -az --rsync-path="mkdir -p /home/nao/ws_ros_additional_packages && rsync"  /home/nao/ws_rapp_nao/src/rapp-robot-nao/rapp_ros_naoqi_wrappings/ros_packages_config nao@$1:/home/nao/ws_ros_additional_packages/ros_packages_config
