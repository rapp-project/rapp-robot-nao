...
rsync -az --rsync-path="mkdir -p /home/nao/ws_rapp_applications_nao/nao/hz_packages/ && rsync" /home/nao/ws_rapp_applications/rapp-applications/nao/hz_packages/ nao@$1:/home/nao/ws_rapp_applications_nao/nao/hz_packages/
