...
echo "Sending packages to nao $1:/home/nao/ - enter password for NAO (nao)"
scp /home/nao/ws_rapp_nao.tar.gz /home/nao/ws_ros_additional_packages.tar.gz /home/nao/ws_ros.tar.gz nao@$1:/home/nao/

echo "Sending scripts to nao $1:/home/nao/ - enter password for NAO (nao)"
scp /home/nao/nao_scripts.tar.gz nao@$1:/home/nao/

echo "Sending nao data to nao $1:/home/nao/ - enter password for NAO (nao)"
