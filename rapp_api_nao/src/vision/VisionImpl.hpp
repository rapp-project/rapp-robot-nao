...
public:
	...
	*/
	...
	rapp::object::QRCode3D qrCodeDetection(rapp::object::picture imgFrame, std::vector<std::vector<float>> robotToCameraMatrix, float landmarkTheoreticalSize = 0.16f, double & camera_matrix[3][3]);/*
